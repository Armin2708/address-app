...
class CountryRepositoryTest extends AbstractTestContainer {
    ...
    void deleteCountryByName() {
        ...
        // When
        underTest.deleteCountryByName(name);
        var foundCountry = underTest.findByName(name);
    ...
    void findByName() {
        // Given
        String name = "CountryTest";
        Country country = new Country("TST",name);
        underTest.save(country);
        ...
        assertThat(foundCountry.get().getName()).isEqualTo(name);
    }
